...
# Drop rows containing NaN values in the 'angle' column
emg_df.dropna(subset=['angle'], inplace=True)
...
emg_df.to_csv("merged_dataset_version_2_dropna.csv", index=False)
