...
folder_in_use = "C:/Users/fkgde/Documents/PlatformIO/Projects/Internship 2023/output/official recordings/video/video mediapipe/"
...
out = cv2.VideoWriter('body_and_hand_output_'+ filename, fourcc, fps, (int(cap.get(cv2.CAP_PROP_FRAME_WIDTH)), int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))))
...
landmarks_df.to_csv('body_and_hand_landmarks_data_'+filename[:-4]+'.csv', index=False)
