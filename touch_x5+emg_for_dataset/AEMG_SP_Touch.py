...
NUM_OF_SENSORS = 7  # 2 EMG sensors + 3 touch sensors
...
sensor_placement_dict = {
    1: "Outer forearm sensor value (1)",
    2: "Inner forearm sensor value (2)",
    7: "Touch sensor 1 (thumb)",
    6: "Touch sensor 2 (index finger)",
    5: "Touch sensor 3 (middle finger)",
    4: "Touch sensor 4 (ring finger)",
    3: "Touch sensor 5 (pinky finger)",
}
